...
local function UIKey(key, baseKeyWidth, rowHeight, keySpacing)
    ...
    local uiKey = MasterFramework:MouseOverResponder(
            MasterFramework:StackInPlace({
                ...
                MasterFramework:Text(key.name, textColor, nil, nil, MasterFramework:Font("Poppins-Regular.otf", 7, 0.2, 1.3))
            }, 0.5, 0.5),
...
function widget:Initialize()
    ...
    local keySpacing = 1
    local baseKeyHeight = 16
    local baseKeyWidth = 15

    keyCornerRadius = MasterFramework:Dimension(4)
